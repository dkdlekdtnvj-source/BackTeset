...
def _vectorbt_backtest(
    ...
    # Construct the portfolio without specifying a direction.  When both
    # long/short entry and exit arrays are provided, vectorbt's `direction`
    # argument has no effect and leads to a warning.  Omitting the argument
    # avoids the warning and allows vectorbt to infer the direction from the
    # provided signals automatically.
